...
def write_encrypted_content_to_github_repo(repo_owner, repo_name, file_path, content, token=None):
    headers = {
...
input_content, input_sha = read_input_from_github_repo(repo_owner, repo_name, input_file_path, github_token)
if input_content:
    ...
    write_encrypted_content_to_github_repo(repo_owner, repo_name, output_file_path, encrypted_content, github_token)
